        ...
        case 8:
            {
                ...
                if (signed) this.dataview.setInt8(this.offset, value);
                else this.dataview.setUint8(this.offset, value);
                this.offset += 1;
            }
            break;
        case 16:
            {
                if (signed) this.dataview.setInt16(this.offset, value, false);
                else this.dataview.setUint16(this.offset, value, false);
                this.offset += 2;
            }
            break;
        case 32:
            {
                if (signed) this.dataview.setInt32(this.offset, value, false);
                else this.dataview.setUint32(this.offset, value, false);
                this.offset += 4;
            }
            break;
        case 64:
            ...
            break;
        default:
            throw new Exception("integer length not correct");
    }
...
Binary.prototype.encodeFloat = function encodeFloat(value, isDouble) {
    ...
    if (l < 0) this.appendBuffer(new ArrayBuffer(-l), false);
    if (isDouble) this.dataview.setFloat64(this.offset, value, false);
    else this.dataview.setFloat32(this.offset, value, false);
    this.offset += 8;
};
...
Binary.prototype.toInt8 = function() {
    return new TypedNumber(this.decodeInt(8, true), 'int8');
};
Binary.prototype.fromInt8 = function(data) {
    return this.encodeInt(data, 8, false);
};
Binary.prototype.toUint8 = function() {
    return new TypedNumber(this.decodeInt(8, false), 'uint8');
};
Binary.prototype.fromUint8 = function(data) {
    return this.encodeInt(data, 8, false);
};
Binary.prototype.toInt16 = function() {
    return new TypedNumber(this.decodeInt(16, true), 'int16');
};
Binary.prototype.fromInt16 = function(data) {
    return this.encodeInt(data, 16, true);
};
Binary.prototype.toUint16 = function() {
    return new TypedNumber(this.decodeInt(16, false), 'unt16');
};
Binary.prototype.fromUint16 = function(data) {
    return this.encodeInt(data, 16, false);
};
Binary.prototype.toInt32 = function() {
    return new TypedNumber(this.decodeInt(32, true), 'int32');
};
Binary.prototype.fromInt32 = function(data) {
    return this.encodeInt(data, 32, true);
};
Binary.prototype.toUint32 = function() {
    return new TypedNumber(this.decodeInt(32, false), 'uint32');
};
Binary.prototype.fromUint32 = function(data) {
    return this.encodeInt(data, 32, false);
};
Binary.prototype.toInt64 = function() {
    return new TypedNumber(this.decodeInt(64, true), 'int64');
};
Binary.prototype.fromInt64 = function(data) {
    return this.encodeInt(data, 64, true);
};
Binary.prototype.toUint64 = function() {
    return new TypedNumber(this.decodeInt(64, false), 'uint64');
};
Binary.prototype.fromUint64 = function(data) {
    return this.encodeInt(data, 64, false);
};
Binary.prototype.toFloat32 = function() {
    return new TypedNumber(this.decodeFloat(false), 'float32');
};
Binary.prototype.fromFloat32 = function(data) {
    return this.encodeFloat(data, false);
};
Binary.prototype.toFloat64 = function() {
    return new TypedNumber(this.decodeFloat(true), 'float64');
};
Binary.prototype.fromFloat64 = function(data) {
    return this.encodeFloat(data, true);
};
...
BitSet.prototype.equals = function(v) {
    if (v instanceof BitSet) {
        ...
        if (l > 0)
            for (var i = 0; i < l - 1; i++)
                if (this.store[i] != v.store[i]) return false;
        if (l1 != l2) {
            var store, k, size;
            ...
            var kl = k / 32;
            if (kl > 0)
                for (var i = 0; i < kl - 1; i++)
                    if (store[l + i] != 0) return false;
            var mask = 0;
            var p = size % 32;
...
BON.calculateSize = function(enumerable, typed, stripped, obj, type) {
    ...
    switch (type) {
        case 0:
            return (!typed) ? 0 : 1; // null is skipped
        case 1:
            {
        ...
        case 10:
            return (!typed) ? 1 : 2;
        case 11:
            return ((!typed) ? 0 : 1) + Binary.UTF8Length(obj);
        case 12:
        case 13:
            return (!typed) ? 1 : 2;
        case 14:
        ...
        case 23:
            return (!typed) ? 8 : 9;
        case 24:
            return ((!typed) ? 4 : 5) + obj.source.length;
        case 25:
            return ((!typed) ? 4 : 5) + Math.ceil(obj.length() / 8);
        case 26:
            return ((!typed) ? 0 : 1) + Binary.UTF8Length(obj.name) + BON.calculateSize(enumerable, !stripped, stripped, obj.value);
        case 27:
            {
                var c = 4;
                c += (!typed) ? 0 : 1;
...
BON.serialize = function(obj, stripped, checksum, t) {
    ...
    var _serialize = function(typed, stripped, data, obj, t) {
        ...
        switch (t) {
            ...
            case 7:
                ...
                break;
            case 8:
                data.fromReference(obj);
                break;
            case 9:
                data.fromType(obj);
                break;
            case 10:
                data.fromBoolean(obj);
                break;
            case 11:
                data.fromUTF8(obj);
                break;
            ...
            case 17:
                ...
                break;
            case 18:
                data.fromUint64(obj.value);
                break;
            case 19:
                data.fromInt64(obj.value);
                break;
            case 20:
                data.fromFloat32(obj);
                break;
            case 21:
                data.fromFloat64(obj);
                break;
            case 22:
                data.fromBinary(obj);
                break;
            ...
            case 25:
                ...
                break;
            case 26:
                data.fromProperty(obj, stripped);
                break;
            case 27:
                data.fromStream(obj);
                break;
    ...
    if (t == undefined) _serialize(!stripped, stripped, data, obj);
    else _serialize(!stripped, stripped, data, obj, t);
    ...
    var _deserialize = function(data, t) {
        ...
        switch (t) {
            ...
            case 19:
                return data.toUint64();
            case 20:
                return data.toFloat32();
            case 21:
                return data.toFloat64();
            case 22:
                return data.toBinary();
            case 23:
                return data.toDate();
            case 24:
                return data.toRegExp();
            case 25:
            ...
            default:
                throw "undefined data type with code " + t;
        }
